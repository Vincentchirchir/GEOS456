...
def add_legend(project, layout, map_frame, map_name, width, height):
    ...
    # Configure the runtime legend items first using the ArcPy LegendItem API.
    # Esri exposes "show visible features" directly here, and that is the
    # switch that makes a legend item dynamic by page extent.
    ...
    # In a spatial map series, "UseMapSeriesShape" belongs on each legend item,
    # not the legend as a whole. That setting tells ArcGIS Pro to evaluate the
    # item against the current page shape instead of the broader map frame.
    ...
    for item in legend_cim.items:
        ...
        if hasattr(item, "useMapSeriesShape"):
            item.useMapSeriesShape = True
...
def add_standard_texts(project, layout, width, height):
    ...
    texts = [
        ...
        },
        {
            "text": "Intersection",
            "text_x": width * 0.010272727272727,
            "text_y": height * 0.8334352941176470,
            "rotation": 90,
            "name": "Intersection Top",
            "font_size": 6,
            "underline": False,
            "font_style": "Bold",
            "locked": True,
...
def add_boundary_graphics(project, layout, width, height, map_frame):
    ...
    boundaries = [
        ...
        },
        {
            ...
            "x_min_poly": 0,
            "y_min_poly": height * 0.4090941176470590,
            "x_max_poly": width * 0.0118181818181818,
            "y_max_poly": height * 0.7272705882352940,
            "outline": 0.5,
        },
        {
            "polygon_name": "Top Intersection Label Box",
            "x_min_poly": 0,
            "y_min_poly": height * 0.7272705882352940,
            "x_max_poly": width * 0.011818181818182,
            "y_max_poly": height,
            "outline": 0.5,
        },
        {
            "polygon_name": "Bottom Intersection Label Box",
            "x_min_poly": 0,
            "y_min_poly": height * 0.1976000000000000,
            "x_max_poly": width * 0.0118090909090909,
    ...
    bar_lines = [
        ...
        {"name": "Top Bar 5", "y_frac": TOP_BAR5_FRAC},
